...
class Defaults:
    ...
    EPSILON_START = 1.0
    EPSILON_MIN = .1
    EPSILON_DECAY = 2000000  # 1000000
    PHI_LENGTH = 4
    UPDATE_FREQUENCY = 4
    REPLAY_MEMORY_SIZE = 4000000  # 1000000
    BATCH_SIZE = 512  # 32
    NETWORK_TYPE = "nature_dnn"
    FREEZE_INTERVAL = 10000
    REPLAY_START_SIZE = 50000
    RESIZE_METHOD = 'tetris'
    RESIZED_WIDTH = 44  # should be 42
    RESIZED_HEIGHT = 176  # should be 177
    DEATH_ENDS_EPISODE = 'false'  # true
